...
<div class="category-header">
  <p class="section-label">Manifiesto y Carácter del Proyecto</p>
  <h1 class="category-title">De nuevo amanece, y el gallo vuelve a cantar</h1>
  <p class="category-description">Un espacio político de izquierda comprometido con los proyectos históricos de transformación de nuestro pueblo.</p>
</div>
...
<figure style="text-align: center; margin: 40px 0;">
  <img src="{{ 'assets/img/posts/quienes1.jpg' | relative_url }}" 
       alt="Equipo Creamos" 
       class="medium-image">
  <figcaption style="margin-top:15px; color:#666; font-style:italic;">Investigación con rigor, acción con esperanza. Registro del laboratorio de pensamiento. Creamos 2025.</figcaption>
</figure>
...
### Comunicaciones
Entendemos la comunicación como una herramienta estratégica para la disputa de sentidos y la construcción de identidad popular.

<hr class="double-divider">

<div class="post-meta" style="text-align: center; margin-top: 40px; font-weight: bold;">
  EQUIPO DE INVESTIGACIÓN-ACCIÓN | BOGOTÁ, COLOMBIA
</div>
